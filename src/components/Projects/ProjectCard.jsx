...
function ProjectCard(props) {
    return (
        <a className="card col-11 col-sm-10 col-md-5 col-xl-4 mb-5 mx-sm-2" href={props.link} target="_blank">
            ...
            <img className="float-end pb-md-2 pb-xl-0" id={props.id} src={kangaroo}  alt={props.alt} />
        </a>
    )
}
...
{/* id={projects[0].id} title={projects[0].title} subtitle={projects[0].tech} text={projects[0].description} image={projects[0].image} link={projects[0].link} */}